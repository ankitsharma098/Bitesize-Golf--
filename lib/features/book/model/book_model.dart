...
import '../entity/book_entity.dart' as entity;
...
class BookModel {
  ...
  entity.Book toEntity() => entity.Book(
    id: id,
    title: title,
    description: description,
    estimatedReadTime: estimatedReadTime,
  ...
  factory BookModel.fromEntity(entity.Book book) => BookModel(
    id: book.id,
    title: book.title,
    description: book.description,
    estimatedReadTime: book.estimatedReadTime,
    levelNumber: book.levelNumber,
    pdfUrl: book.pdfUrl,
    accessTier: book.accessTier,
